...
jsPage.prototype.showPage = function(dir)
{
	...
	// LD-8188: its safe to comment out below line since it will be called in ifr.contentWindow.ReFlow(), 
	// and if its missed again will be called using postPageShow 
